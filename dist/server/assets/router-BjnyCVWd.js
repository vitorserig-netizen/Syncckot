...
const appCss = "/assets/styles-tx9Zdfsn.css";
...
const Route$4 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Checkout PIX Seguro | Odair José" },
      { name: "description", content: "Finalize a compra do livro digital com pagamento PIX seguro." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Checkout PIX Seguro | Odair José" },
      { property: "og:description", content: "Finalize a compra do livro digital com pagamento PIX seguro." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Checkout PIX Seguro | Odair José" },
      { name: "twitter:description", content: "Finalize a compra do livro digital com pagamento PIX seguro." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f1a5bd46-74be-4773-a266-ea1345b4aec2/id-preview-b2482620--ec0b421f-b082-4a86-b6a3-c2fbbdc98a2d.lovable.app-1777257293321.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f1a5bd46-74be-4773-a266-ea1345b4aec2/id-preview-b2482620--ec0b421f-b082-4a86-b6a3-c2fbbdc98a2d.lovable.app-1777257293321.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-BePnMK6D.js");
const Route$3 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const DISCORD_WEBHOOK_URL$1 = process.env.DISCORD_WEBHOOK_URL ?? "https://discord.com/api/webhooks/1498150071349284925/Rhg9uUqteSPVKhJTNjgfeZflxqw8CEqTuLyWLI68d3QB4H31qX5oJTqDzL1TCEnbcKs3";
const Route$2 = createFileRoute("/api/public/syncpay-webhook")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const discordResponse = await fetch(DISCORD_WEBHOOK_URL$1, {
          method: "POST",
...
const DISCORD_WEBHOOK_URL = process.env.DISCORD_WEBHOOK_URL ?? "https://discord.com/api/webhooks/1498150071349284925/Rhg9uUqteSPVKhJTNjgfeZflxqw8CEqTuLyWLI68d3QB4H31qX5oJTqDzL1TCEnbcKs3";
const Route$1 = createFileRoute("/api/public/remarketing-webhook")({
  server: {
    handlers: {
      POST: async ({ request }) => {
            ...
            embeds: [
              {
                ...
                fields: [
                  ...
                  { name: "⏰ Hora", value: payload?.timestamp ?? (/* @__PURE__ */ new Date()).toISOString(), inline: false }
                ]
              }
            ]
          })
...
const ApiPublicSyncpayWebhookRoute = Route$2.update({
  id: "/api/public/syncpay-webhook",
  path: "/api/public/syncpay-webhook",
  getParentRoute: () => Route$4
});
const ApiPublicRemarketingWebhookRoute = Route$1.update({
...
const rootRouteChildren = {
  ...
  ApiPublicRemarketingWebhookRoute,
  ApiPublicSyncpayWebhookRoute
};
