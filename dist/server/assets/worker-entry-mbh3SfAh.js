...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Tk4ysJPS.js");
...
const manifest = {
  "3bc294a0a9fe012158cd09382eee91a99701720732837525f3eb73fc19a80264": {
    functionName: "createPixPayment_createServerFn_handler",
    importer: () => import("./syncpay.functions-D3pmsPHr.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BjnyCVWd.js").then((n2) => n2.a),
